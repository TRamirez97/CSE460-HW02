...
main(void)
{
 ...
 uint ppid;
 uid = getuid();
   f:	e8 d7 03 00 00       	call   3eb <getuid>
 ...
 printf(2, "Setting UID to 100\n");
  24:	58                   	pop    %eax
  25:	5a                   	pop    %edx
  26:	68 4c 08 00 00       	push   $0x84c
  2b:	6a 02                	push   $0x2
  2d:	e8 9e 04 00 00       	call   4d0 <printf>
 setuid(100);
  32:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  39:	e8 c5 03 00 00       	call   403 <setuid>
 uid = getuid();
  3e:	e8 a8 03 00 00       	call   3eb <getuid>
 printf(2, "Current UID is: %d\n", uid);
  43:	83 c4 0c             	add    $0xc,%esp
  46:	50                   	push   %eax
  47:	68 38 08 00 00       	push   $0x838
  4c:	6a 02                	push   $0x2
  4e:	e8 7d 04 00 00       	call   4d0 <printf>
 gid = getgid();
  53:	e8 9b 03 00 00       	call   3f3 <getgid>
 printf(2, "Current GID is: %d\n", gid);
  58:	83 c4 0c             	add    $0xc,%esp
  5b:	50                   	push   %eax
  5c:	68 60 08 00 00       	push   $0x860
  61:	6a 02                	push   $0x2
  63:	e8 68 04 00 00       	call   4d0 <printf>
 printf(2, "Setting GID to 100\n");
  68:	59                   	pop    %ecx
  69:	5b                   	pop    %ebx
  6a:	68 74 08 00 00       	push   $0x874
  6f:	6a 02                	push   $0x2
  71:	e8 5a 04 00 00       	call   4d0 <printf>
 setgid(100);
  76:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  7d:	e8 89 03 00 00       	call   40b <setgid>
 gid = getgid();
  82:	e8 6c 03 00 00       	call   3f3 <getgid>
 printf(2, "Current GID is: %d\n", gid);
  87:	83 c4 0c             	add    $0xc,%esp
  8a:	50                   	push   %eax
  8b:	68 60 08 00 00       	push   $0x860
  90:	6a 02                	push   $0x2
  92:	e8 39 04 00 00       	call   4d0 <printf>
 ppid = getppid();
  97:	e8 5f 03 00 00       	call   3fb <getppid>
  9c:	89 c3                	mov    %eax,%ebx
 if(getppid() > 0)
  9e:	e8 58 03 00 00       	call   3fb <getppid>
  a3:	83 c4 10             	add    $0x10,%esp
  a6:	85 c0                	test   %eax,%eax
  a8:	74 24                	je     ce <main+0xce>
 {
 	printf(2, "My parent process is: %d\n", ppid);
  aa:	52                   	push   %edx
  ab:	53                   	push   %ebx
  ac:	68 88 08 00 00       	push   $0x888
  b1:	6a 02                	push   $0x2
  b3:	e8 18 04 00 00       	call   4d0 <printf>
 	printf(2, "Done!\n");
  b8:	59                   	pop    %ecx
  b9:	5b                   	pop    %ebx
  ba:	68 a2 08 00 00       	push   $0x8a2
  bf:	6a 02                	push   $0x2
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb b4 08 00 00       	mov    $0x8b4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 68 0b 00 00       	mov    0xb68,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 68 0b 00 00       	mov    %eax,0xb68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 68 0b 00 00       	mov    0xb68,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 68 0b 00 00 6c 	movl   $0xb6c,0xb68
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 6c 0b 00 00       	mov    $0xb6c,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 6c 0b 00 00 6c 	movl   $0xb6c,0xb6c
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 822:	00 00 00 
    if(p->s.size >= nunits){
